...
class HeartbeatSender {
 public:
  ...
  HeartbeatSender(NodeID self_node_id,
...
class NodeManager : public rpc::NodeManagerServiceHandler {
 ...
 private:
  ...
  void ResourceUsageBatchReceived(
  ...
  void HandleGetObjectsInfo(
      const rpc::GetObjectsInfoRequest &request,
  ...
  absl::flat_hash_map<ObjectID,
      ...
      async_plasma_objects_notification_
          GUARDED_BY(plasma_object_notification_lock_);
  ...
  std::shared_ptr<PlacementGroupResourceManager>
